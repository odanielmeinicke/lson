...
public final class ComparisonOperatorFilter implements Filter {

    private final @NotNull Parameter primary;
    private final @NotNull Parameter secondary;

    private final @NotNull ComparisonOperator operator;

    public ComparisonOperatorFilter(@NotNull Parameter primary, @NotNull Parameter secondary, @NotNull ComparisonOperator operator) {
    ...
    public boolean equals(@Nullable Object object) {
        ...
        if (!(object instanceof ComparisonOperatorFilter)) return false;
        @NotNull ComparisonOperatorFilter that = (ComparisonOperatorFilter) object;
    ...
    public enum ComparisonOperator implements Operator {
         ...
         * @param precedence the precedence level of the operator, determining the order of evaluation.
         */
        ComparisonOperator(@NotNull String symbol, int precedence) {
            this.symbol = symbol;
